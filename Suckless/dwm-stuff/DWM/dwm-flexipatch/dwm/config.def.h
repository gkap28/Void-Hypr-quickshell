...
static const unsigned int barborderpx    = 0;  // Oder ein anderer Wert für den Balken-Rand
static const int swallowfloating         = 0;  // 1 erlaubt das 'Swallowen' von schwebenden Fenstern
...
static char normbordercolor[]            = "#F48324";
...
static char tagsselfgcolor[]             = "#ec6b64";
...
static const Rule rules[] = {
    ...
    RULE(.instance = "splogout",
         .tags = SPTAG(1),
         .isfloating = 1)

    RULE(.instance = "spvsp2",
         .tags = SPTAG(2),
         .isfloating = 1)
