...
hl.on("hyprland.start", function () 
    ...
    hl.exec_cmd("/usr/libexec/polkit-gnome-authentication-agent-1 &")
     ...
     -- Cursor für alle Programme aktivieren
    hl.exec_cmd("dbus-update-activation-environment --all XCURSOR_THEME=" .. cursor_theme .. " XCURSOR_SIZE=" .. cursor_size .. " &")

    -- 2. USB-Automount (udiskie) im Hintergrund starten
    hl.exec_cmd("udiskie &")
